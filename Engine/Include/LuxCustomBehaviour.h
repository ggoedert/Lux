...
#define derived_custom_behaviour_class_default_implementations(T, S, U, OD)                                                                                 \
    virtual_table_type(Object) virtual_table_instance(T##_Object) = {                                                                                       \
        (Object_Delete_Type)T##_Delete                                                                                                                      \
    };                                                                                                                                                      \
    ...
    void T##_Constructor(GameObject *gameObject, T *this) {                                                                                                 \
        CustomBehaviour_Constructor(gameObject, &this->CustomBehaviour, &virtual_table_instance(T##_Object), &virtual_table_instance(T##_CustomBehaviour)); \
    }                                                                                                                                                       \
