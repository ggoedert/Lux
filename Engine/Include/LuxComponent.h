...
#define component_delete_no_destructor_implementation(T) void T##_Delete(GameObject *gameObject, T *this) { free(this); }
...
#define component_constructor_destructor_implementations(T, AD, CI, DI) \
    component_constructor_implementation(T, AD, REM_ENCLOSE(CI))        \
...
#define component_no_destructor_implementations(T, AD, A, CI)    \
    component_constructor_implementation(T, AD, REM_ENCLOSE(CI)) \
    component_new_implementation(T, AD, A)                       \
    component_delete_no_destructor_implementation(T)
